...
document.addEventListener("DOMContentLoaded", () => {
    ...
    **/
     ...
     * aggregates when their 'stuck' parameter is true, which is triggered when they neighbor 
     * an aggregate (coordinate found in aggregate)
    **/
    let objects = new Set();
    ...
    class Walker {
        ...
        walk() {
            ...
            // let randomWeightedDirection = weightedRand({0: 0.4, 1: 0.4, 2: 0.2, 3: 0.2})
