    ...
    const update = (selection, data) => {
        ...
        cells
            .enter()
                .append("rect")
                .attr("x", d => {
                    if (d[0] * cellWidth > 850) {
                        return (d[0] * cellWidth) % 850;
                    } else if (d[0] * cellWidth < 0) {
                        return 851 + d[0] * cellWidth;
                    } else {
                        return d[0] * cellWidth;
                    }                  
                })
                .attr("y", d => {
                    if (d[1] * cellWidth > 1000) {
                        return (d[1] * cellWidth) % 1000;
                    } else if (d[1] * cellWidth < 0) {
                        return 1001 + d[1] * cellWidth;
                    } else {
                        return d[1] * cellWidth;
                    }
                })
